 ...
 */
public class Fashonation_MyData
{
    ...
    static Integer[] drawableArray = {R.drawable.jacket, R.drawable.jacket, R.drawable.jacket,
            R.drawable.jacket, R.drawable.jacket, R.drawable.jacket, R.drawable.jacket,
            R.drawable.jacket, R.drawable.jacket, R.drawable.jacket,R.drawable.jacket};
